 ...
 */
public abstract class TypeReference<T extends com.alaya.abi.datatypes.Type>
    ...
    public static <T extends com.alaya.abi.datatypes.Type> TypeReference<T> create(
            final Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.alaya.abi.datatypes.Type>
