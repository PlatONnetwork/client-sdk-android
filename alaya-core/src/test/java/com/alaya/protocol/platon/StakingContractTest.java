...
import com.alaya.platon.StakingAmountType;
import com.alaya.platon.bean.Node;
import com.alaya.platon.bean.ProgramVersion;
import com.alaya.platon.bean.StakingParam;
import com.alaya.platon.bean.UpdateStakingParam;
import com.alaya.platon.contracts.StakingContract;
...
public class StakingContractTest {
  ...
  /*  @Test
    ...
    public void addStaking() {
        try {
            BigDecimal addStakingAmount = Convert.toVon("4000000", Convert.Unit.ATP).add(new BigDecimal("999999999999999998"));
