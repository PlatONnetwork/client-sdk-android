...
import com.alaya.generated.HumanStandardToken;
...
import static com.alaya.generated.HumanStandardToken.deploy;
import static com.alaya.tx.TransactionManager.DEFAULT_POLLING_FREQUENCY;
...
public class HumanStandardTokenGeneratedIT extends Scenario {
    ...
    public void testContract() throws Exception {
        ...
        Subscription transferEventSubscription = contract.transferEventObservable(
                ...
                new Action1<HumanStandardToken.TransferEventResponse>() {
                    @Override
        ...
        Subscription approvalEventSubscription = contract.approvalEventObservable(
                DefaultBlockParameterName.EARLIEST,
                DefaultBlockParameterName.LATEST).subscribe(
                new Action1<HumanStandardToken.ApprovalEventResponse>() {
                    @Override
